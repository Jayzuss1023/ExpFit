...
const categories = [
  ...
  { name: "Cycling", icon: Bike, classes: "960+", color: "text-amber-500" },
  {
    name: "Strength",
    icon: Dumbbell,
    classes: "3,200+",
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        {/* Gradient Background */}
        <div className="absolute inset-0 bg-linear-to-r from-primary/5 via-background to-primary/10" />
      ...
      <section className="container mx-auto px-4 py-20 md:py-28">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            that match your firness goals.
          </p>
        </div>

        <div className="grid grid-cols md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="relative">
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-12 left-[55%] w-full h-0.5 bg-linear-to-r from-primary/40 to-primary/10" />
                )}
              ...
              >
                ...
                <CardContent className="text-center">
                  <div className="mb-6">
                    ...
                    <span className="text-sm tex-tmuted-foreground mb-6">
                      /month
                    </span>
                  </div>
