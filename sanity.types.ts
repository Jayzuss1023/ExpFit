...
export type AllSanitySchemaTypes = Booking | ClassSession | Venue | SanityImageCrop | SanityImageHotspot | Slug | Activity | Category | UserProfile | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
