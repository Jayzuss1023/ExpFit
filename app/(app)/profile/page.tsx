    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b bg-linear-to-r from-primary/5 via-background to-primary/5">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-muted0foreground mt-2">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-2xl space-y-6">
          ...
          {/* Location Preferenced Card */}
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 bg-primary/10 items-center justify-center rounded-xl">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-center gap-3 rounded-xl bg-muted/50 p-4 transition-colors hover:bg-muted">
                ...
                <div className="flex items-start gap-3 bg-muted/50 rounded-xl p-4 transition-colors  hover:bg-muted">
                  <TargetIcon className="mt-0.5 w-5 h-5 text-primary" />
                  <div>
