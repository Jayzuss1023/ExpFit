  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="border-b bg-linear-to-br from-primary/10 via-background to-primary/5">
        <div className="container mx-auto px-4 py-12 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {requiredTierName ? (
              <>
                Upgrade to <span>{requiredTierName}</span>
              </>
            ) : (
              <>
      ...
      <main className="container mx-auto px-4 py-12">
        {/* Pricing Table */}
        <div className="max-w-5xp max-auto">
          <PricingTable
            appearance={{
              elements: {
                pricingTable: {
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="text-center transition-all hover:shadow-lg hover:border-primary/30">
              <CardContent className="pt-6">
                ...
                <h3 className="font-semibold">3-Day Free Trial</h3>
            ...
            <Card className="text-center transition-all hover:shadow-lg hover:border-primary/30">
              <CardContent className="pt-6">
                ...
                <h3 className="font-semibold mb-2">Canel Anytime</h3>
                <p className="text-sm text-muted-foreground">
        ...
        {/* Back Link */}
        <div>
          <Link href={sessionId ? `/classes/${sessionId}` : "/classes"}>
            <ArrowLeft className="w-4 h-4" /> Back to{" "}
            {sessionId ? "class" : "classes"}
          </Link>
        </div>
      </main>
    </div>
